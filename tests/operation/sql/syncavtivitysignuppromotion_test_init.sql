...
INSERT INTO [dbo].[Tpo_PublicClass_Activitity_Moment] ([MomentId], [ActivitityId], [BeginDate], [EndDate], [MomentDescription], [ReachHomeworkTimes], [HasPromotionForm], [SignClockCount]) VALUES ( N'1005', N'1005', CONVERT(varchar,dateadd(day,-1,GETDATE()),23), CONVERT(varchar,dateadd(day,-1,GETDATE()),23), null, 0, 0, 0)
