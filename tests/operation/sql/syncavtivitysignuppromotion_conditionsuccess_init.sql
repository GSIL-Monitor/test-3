...
DELETE FROM [dbo].[Tpo_PublicClass_UserRiseForm] WHERE [SignupUserID] in ('19710');
DELETE FROM [dbo].[Tpo_PublicClass_Activities_Course] WHERE [ActivityID] in ('1005');
DELETE FROM [dbo].[Zhan_Operation_Activity_SignClock] WHERE [ActivityID] in ('1005');
...
INSERT INTO [dbo].[Tpo_PublicClass_Activitity_Moment] ([MomentId], [ActivitityId], [BeginDate], [EndDate], [MomentDescription], [ReachHomeworkTimes], [HasPromotionForm], [SignClockCount]) VALUES ( N'1005', N'1005', CONVERT(varchar,dateadd(day,-1,GETDATE()),23), CONVERT(varchar,dateadd(day,-1,GETDATE()),23), null, 1, 1, 1)
...
INSERT INTO [dbo].[Tpo_PublicClass_Activities_Course] ([ID], [ActivityID], [CourseType], [StartTime], [EndTime], [VideoUrl], [VideoID], [CreateTime], [CreatedBy], [CourseCommand]) VALUES (N'1005', N'1005', N'5', CONVERT(varchar,dateadd(day,-1,GETDATE()),23) + ' 00:00:00', CONVERT(varchar,dateadd(day,-1,GETDATE()),23) + ' 23:59:59', null, null, N'2018-03-29 20:21:20.457', N'1', N'小站5157')
SET IDENTITY_INSERT [dbo].[Tpo_PublicClass_Activities_Course] OFF
--写入报名记录，绑定班级
INSERT INTO [dbo].[Tpo_PublicClass_Activitity_SignUp] ([ActivityID], [ChannelCode], [CreatedBy], [CreateTime], [SignUpUserID], [IsAudit], [TimeStamp], [GroupName], [GroupNickName], [MomentID], [Moment], [CheckinCount], [HomeworkCount], [HomeworkAccuracy], [PromotionCount]) VALUES (N'1005', N'LY2016111506', N'1', N'2017-01-07 16:20:57.000', N'19710', N'1', DEFAULT, N'活动微信群5', N'newname', N'1005', N'第1阶段', N'1', N'1', N'10', N'1')
--作业
INSERT INTO [dbo].[Zhan_Operation_Activities_Work] ([ActivityId], [WorkId], [CourseId], [SignUpUserId], [Accuracy]) VALUES (N'1005', null, N'1005', N'19710', N'30')
--晋级表单
INSERT INTO [dbo].[Tpo_PublicClass_UserRiseForm] ([SignUpUserId], [PassportId], [UserName], [UserHeadImage], [Status], [Grade], [SubGrade], [BusinessType], [IntentExamDate], [PrepareTimeForExam], [HasExam], [HasTraining], [ExamTimes], [LastExamLearnSelf], [LastExamScore], [LastExamForNowTime], [CurrentEnglishLevel], [TargetScore], [IntentService], [PhoneNumber], [WechatId], [CreateTime], [CreateBy], [UpdateTime], [UpdateBy], [SelfLearningTPO], [PlanToStudyAbroad]) VALUES (N'19710', N'1863271', null, null, N'1', N'502202', N'502204', N'111', N'2017-11-11', N'9833', N'1', N'1', N'10', N'1', N'9804', N'9813', N'9816', N'9823', N'9828,9829', N'13311110000', N'234555', N'2018-03-30 09:51:00.140', N'1', N'2018-03-30 09:53:40.120', N'1', N'1', N'1')
--打卡次数
INSERT INTO [dbo].[Zhan_Operation_Activity_SignClock] ([SignDate], [ActivityId], [MomentId], [GroupId], [SignUpUserId], [CreateTime], [CreateBy], [UpdateTime], [UpdateBy], [TimeStamp]) VALUES (CONVERT(varchar,dateadd(day,-1,GETDATE()),120), N'1005', N'1005', N'1005', N'19710', N'2018-03-05 19:49:10.450', N'1', N'2018-03-05 19:49:10.450', N'1', DEFAULT)